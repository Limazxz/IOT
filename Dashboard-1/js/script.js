...
const topicoSensor = "pedroL/lerSensor"; // Tópico que envia dados do sensor
const topicoLed1 = "pedroL/led1"; // Tópico para controlar o LED 1
const topicoLed2 = "pedroL/led2"; // Tópico para controlar o LED 2
